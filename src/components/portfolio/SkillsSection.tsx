        ...
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-6">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="group relative bg-card rounded-2xl p-6 card-elevated overflow-hidden"
            >
              ...
              <div className={`w-16 h-16 rounded-xl ${skill.bgColor} flex items-center justify-center mb-4 ${skill.textColor} transition-transform group-hover:scale-110`}>
                {skill.icon}
              </div>
